...
<svelte:head>
  <title>Acerca de | SistemasPao</title>
  <meta name="description" content="Acerca de | SistemasPao" />
</svelte:head>

<div class="text-column">
  <div class="w-full mt-4 mb-4">
    <h1>Acerca de <b>Sistemas Pao</b></h1>
    <p>
      En <b>Sistemas Pao</b>, nos apasiona utilizar la tecnología para resolver
      problemas y mejorar vidas. Con experiencia en programación y resolución de
      problemas, nos enfocamos en brindar soluciones innovadoras y efectivas
    ...
    <p>
      ...
      abordan los desafíos del día a día. Nos enfocamos en estar a la vanguardia
